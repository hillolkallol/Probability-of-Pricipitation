...
probability_1 = np.round((((np_tr_df_1/total_train) - (np_te_df_1/total_test))** 2), 4)
probability_5 = np.round((((np_tr_df_5/total_train) - (np_te_df_5/total_test))** 2), 4)
probability_10 = np.round((((np_tr_df_10/total_train) - (np_te_df_10/total_test))** 2), 4)
probability_20 = np.round((((np_tr_df_20/total_train) - (np_te_df_20/total_test))** 2), 4)
probability_40 = np.round((((np_tr_df_40/total_train) - (np_te_df_40/total_test))** 2), 4)
probability_80 = np.round((((np_tr_df_80/total_train) - (np_te_df_80/total_test))** 2), 4)

# print(np.round(probability_1, 4))
np.savetxt('F:/dataset/rain_data/table/bs_1.csv', probability_1, delimiter=',', fmt='%10.5f')
np.savetxt('F:/dataset/rain_data/table/bs_5.csv', probability_5, delimiter=',', fmt='%10.5f')
np.savetxt('F:/dataset/rain_data/table/bs_10.csv', probability_10, delimiter=',', fmt='%10.5f')
np.savetxt('F:/dataset/rain_data/table/bs_20.csv', probability_20, delimiter=',', fmt='%10.5f')
np.savetxt('F:/dataset/rain_data/table/bs_40.csv', probability_40, delimiter=',', fmt='%10.5f')
np.savetxt('F:/dataset/rain_data/table/bs_80.csv', probability_80, delimiter=',', fmt='%10.5f')
